...
- Módulo **What Moved Markets?** con narrativas causales y confianza.
- Módulo **Risk-On / Risk-Off** con score compuesto (FX + eventos + soberano).
- Módulo **Conflict-to-Market Transmission** con impacto por activo.
- Capa geoespacial de **chokepoints** y **rutas energéticas** sobre el globo.
- Selector de país en tiempo real para refrescar la inteligencia soberana.

## Documento de visión completa
- `docs/PLATFORM_BLUEPRINT.md`
- `docs/PMI_MVP_EXECUTION_PLAN.md` (plan maestro UX + frontend + backend + data)
